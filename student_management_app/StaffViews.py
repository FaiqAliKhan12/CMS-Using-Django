...
def staff_leave_apply_leave(request):
...
def get_students(request):
    ...
    session_model = SessionYearModel.objects.get(id=subject_id)
...
def save_attendance_data(request):
    ...
    json_student = json.loads(students_id)

    try:
         # First Attendance Data is Saved on Attendance Model # First Attendance Data is Saved on Attendance Model
...
def get_attendance_student(request):
    ...
    for student in attendance_date:
        data_small = {"id":student.student_id.admin.first_name+""+student.student_id.admin.last_name,"status":student.status}
        list_data.append(data_small)
...
def update_attendance_data(request):
    ...
    try:
        for stud in json_student:
            ...
            attendance_report = AttendanceReport.objects.get(students_id=student,
                                                             attendance_id=attendance)
            attendance_report.save()
        return HttpResponse("OK")
    except:
